...
def run_qwen2vl_model_mirabest_inference(
	datalist, 
	model, processor, 
	datalist_context=None, 
	device="cuda:0", 
	...
	""" Run Qwen2VL inference on Mirabest dataset """
...
def run_qwen2vl_model_gmnist_inference(
	datalist, 
	model, processor, 
	datalist_context=None, 
	device="cuda:0", 
	...
	""" Run Qwen2VL inference on Galaxy MNIST dataset """
