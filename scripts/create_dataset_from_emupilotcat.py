...
def main():
	...
	task_requirements+= "- Include at least one question for each source class (SPURIOUS, COMPACT, EXTENDED, EXTENDED-MULTISLAND, FLAGGED) to determine the bounding box positions of all radio sources of those classes present in the image. Example: 'Please provide the bounding box coordinates of all extended multi-island sources present in the image.'. When answering to this question you must report the normalized bounding box float coordinates with a precision of 2 digits at maximum.\n"
