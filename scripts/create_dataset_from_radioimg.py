...
def main():
	...
	anomaly_msg_list= [
		"Is the image content ordinary or peculiar in terms of contained objects? Answer concisely: Yes or No.",
		"Do you see any radio source with peculiar morphology in the presented image? Answer concisely: Yes or No.",
		"Please report if the given image contains any radio source with an anomalous or peculiar morphology. Answer concisely: Yes or No."
	]
